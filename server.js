...
function filterByQuery(query, animalsArray) {
    ...
    if (query.personalityTraits) {
       ...
       personalityTraitsArray.forEach(trait => {
           ...
           // array will then conatin only the entries that conatin the trait,
           // do at the end we'll have an array of animals that have every one 
...
app.post('/api/animals', (req, res) => {
    // set an id based on what index of the array will be
